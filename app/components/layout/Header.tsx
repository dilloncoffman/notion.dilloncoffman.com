...
export default function Header() {
  ...
  return (
    <header className="bg-dillon-blue">
      <nav
        className="mx-auto flex max-w-7xl items-center justify-between px-2 py-4 md:p-6 lg:px-8"
        aria-label="Global"
      >
        <NextLink
          href="/"
        ...
        <div className="flex sm:hidden">
          <button
            ...
            className="-m-2.5 mx-2.5 inline-flex items-center justify-center rounded-md bg-dillon-slate p-1 text-gray-700"
          >
        ...
        <div className="hidden text-xl text-white sm:flex sm:gap-x-6 lg:gap-x-12">
          <NextLink href="/about" className="font-semibold leading-6">
            About
          </NextLink>
          <NextLink href="/blog" className="font-semibold leading-6">
            Blog
          </NextLink>
          <NextLink href="/music" className="font-semibold leading-6">
            Music
          </NextLink>
        </div>
      </nav>
      ...
      >
        ...
        <div className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            ...
            <button
              type="button"
              className="-m-2.5 rounded-md p-1 text-gray-700 hover:bg-dillon-slate hover:text-white"
              onClick={toggleMobileMenu}
            >
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6 text-dillon-blue">
                <NextLink
                  onClick={toggleMobileMenu}
                  href="/about"
